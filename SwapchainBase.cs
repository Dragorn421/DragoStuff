// Copied and adapted from https://github.com/AvaloniaUI/Avalonia/blob/release/11.3.0/src/Avalonia.Base/Rendering/SwapchainBase.cs
...
abstract class SwapchainBase<TImage> : IAsyncDisposable
    where TImage : class, ISwapchainImage
{
