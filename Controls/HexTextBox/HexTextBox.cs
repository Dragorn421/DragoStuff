...
public class HexTextBox : TextBox
{
    public static readonly StyledProperty<uint?> ValueProperty =
        AvaloniaProperty.Register<HexTextBox, uint?>(nameof(Value), defaultValue: null, defaultBindingMode: BindingMode.TwoWay);
    public uint? Value
    {
    ...
    public HexTextBox()
    {
        ...
        PointerWheelChanged += (sender, e) =>
        {
            ...
            {
                case KeyModifiers.Shift | KeyModifiers.Alt: offset = 1; break;
                case KeyModifiers.Control | KeyModifiers.Alt: offset = 1; break;
                case KeyModifiers.Alt: offset = 4; break;
                case KeyModifiers.Control: offset = 0x100; break;
                case KeyModifiers.Shift: offset = 0x100; break;
                case KeyModifiers.Shift | KeyModifiers.Control: offset = 0x1000; break;
                case KeyModifiers.None: offset = 0x10; break;
