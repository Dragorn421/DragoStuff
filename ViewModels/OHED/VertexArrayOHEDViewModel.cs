...
public partial class VertexArrayOHEDViewModel : ObservableObject, IObjectHolderEntryDetailsViewModel
{
    public class VertexEntry
    {
        ...
        public VertexEntry(int index, uint address, int coordX, int coordY, int coordZ, int texCoordS, int texCoordT, byte colorRorNormalX, byte colorGorNormalY, byte colorBorNormalZ, byte alpha)
        {
            Index = index;
            Address = address;
            CoordX = coordX;
