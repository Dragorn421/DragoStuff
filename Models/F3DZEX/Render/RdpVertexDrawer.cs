...
namespace F3DZEX.Render
{
    public class RdpVertexDrawer
    {
        ...
        public RdpVertexDrawer()
        {
            ...
            _wireframeShader = ShaderHandler.FromSrcFilesInShadersDir("rdpVtx.vert", "wireframe.frag", "wireframe.geom");
            _nrmShader = ShaderHandler.FromSrcFilesInShadersDir("rdpVtx.vert", "coloredVtx.frag", "rdpVtxNrm.geom");
